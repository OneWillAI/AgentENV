...
A later pause retains the prior generation for rollback. Collection runs only
after shutdown has closed lifecycle admission and proven every guest stopped.
...
paths, ambiguous metadata, or quarantines stop collection safely. Startup does
