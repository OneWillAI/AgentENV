...
| Kernel image | `<deps_path>/kernel/{version}/vmlinux.bin` | Guest kernel | VM boot source | Downloaded during setup when missing. Old versions are retained until manually removed. |
